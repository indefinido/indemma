...
restful = {
  model: {
    ...
    get: function(action, data) {
      ...
      this.route = "/" + (model.pluralize(this.resource)) + "/" + action;
  ...
  record: {
    ...
    assign_attributes: function(attributes) {
      var association, association_attributes, association_name, associations_attributes, attribute, message, singular_resource, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _results;
